...
export function Pre({ children, className, "data-filename": filename, "data-copy": copy, "data-language": language, icon: Icon, ...props }) {
	...
	return (
		<div className="nextra-code relative mt-6 first:mt-0">
			{filename && (
				<div className={cn("px-4 text-xs text-gray-700 dark:text-gray-200", "bg-gray-100 dark:bg-neutral-900", "flex items-center h-10 gap-2 rounded-t-md", classes.border, "border-b-0")}>
