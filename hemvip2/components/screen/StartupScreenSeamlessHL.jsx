...
// TODO: final wording for Seamless Human-Likeness startup screen.
const StartupScreenSeamlessHL = memo(function StartupScreenSeamlessHL() {
		...
		<>
			<h2 className="mx-[10%] border-b mb-3">
				<div className="flex justify-center mb-2 gap-2 text-center font-semibold tracking-tight text-slate-900 text-2xl ">
					<div>📢</div> Seamless Human-Likeness — User study guide <div className="-scale-x-90">📢</div>
				</div>
			</h2>
...
export default StartupScreenSeamlessHL
