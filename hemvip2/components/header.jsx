	...
	return (
		...
		<Navbar>
			<Link className="flex items-center hovesr:opacity-75 ltr:mr-auto rtl:ml-auto" href="/">
				...
				<span className="max-md:hidden select-none font-extrabold ltr:ml-2 rtl:mr-2" title="GENEA: Gesture Generation Research Community">
					GENEA
				</span>
			</Link>
			{/* <Link className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 max-md:hidden whitespace-nowrap font-medium subpixel-antialiased" aria-current="true" href="/docs/getting-started">Docs</Link> */}
			...
			{/* <Link className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 max-md:hidden whitespace-nowrap text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" aria-current="false" href="/examples/basic">Examples</Link> */}
			{/* <Link className="text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 max-md:hidden whitespace-nowrap text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" aria-current="false" href="/blog">Blog</Link> */}
			{/* <LinkuthButton /> */}
			...
			<Link href="https://github.com/genea-workshop" target="blank" rel="noreferrer">
				<Github />
				<span className="sr-only">GitHub</span>
			</Link>
			<Link href="https://twitter.com/WorkshopGenea" target="blank" rel="noreferrer">
				<Twitter />
			</Link>
		</Navbar>
		//     </nav>
