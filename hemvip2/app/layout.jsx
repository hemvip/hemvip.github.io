	...
	return (
		<html lang="en" suppressHydrationWarning dir="ltr">
			<head>
				...
				<meta name="description" content="Pairwise Comparison of Gesture Generation AI Model Studies" />
				<meta name="author" content="GENEA" />
				<title>HEMVIP2 - Pairwise Comparison of Gesture Generation AI Model Studies</title>
			</head>
			<body>{children}</body>
		</html>
	)
